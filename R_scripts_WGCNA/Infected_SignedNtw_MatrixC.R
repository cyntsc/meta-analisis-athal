...
###                                                       SAMPLES OF A.THALIANA MATRIX C    
###
...
athalData3 <-  read.csv(here("data", "matrix_C_infected.csv"), header=TRUE,  sep='\t')
...
#warnings()
sft
write.table(sft, file = "results/SFT_corr_Athal_Infected_MatrixC.txt", sep = ",", quote = FALSE, row.names = T)
