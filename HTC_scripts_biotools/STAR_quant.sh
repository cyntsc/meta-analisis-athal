...
STAR --runThreadN 12 --genomeDir /data/run/cyntsc/athal_STAR_idx_genome/ --readFilesIn /data/run/cyntsc/Dataset1_At_sana_trimmo/SRR3383640_trimmo.fq --outFileNamePrefix /data/run/cyntsc/athal_STAR_counts/SRR3383640_ --outSAMtype BAM SortedByCoordinate --quantMode GeneCounts
