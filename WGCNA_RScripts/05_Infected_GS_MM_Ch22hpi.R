...
##                      ANALYSIS FOCUSED IN ARABIDOPSIS WITH COLLETOTRICHUM At 22 HPI
##
###################################################################################################
...
# Define variable Ch_22 containing the Ch_22 column of datTrait2
...
file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/Ch22", module, "GS_MM_genes.csv", sep = "_");
