...
##                      ANALYSIS FOCUSED IN ARABIDOPSIS HEALTHY A LAS 12 HPI
##
###################################################################################################
...
# Define variable Bc_12 containing the Bc_12 column of datTrait2
Bc_12 = as.data.frame(datTraits2$B_12hpi);
names(Bc_12) = "Bc_12hpi"
...
geneTraitSignificance = as.data.frame(cor(athalData3, Bc_12, use = "p"));               # Gene Significance GS is the absolute value of the correlation between the gene and the trait.
GSPvalue = as.data.frame(corPvalueStudent(as.matrix(geneTraitSignificance), nSamples));
names(geneTraitSignificance) = paste("GS.", names(Bc_12), sep="");
names(GSPvalue) = paste("p.GS.", names(Bc_12), sep="");
...
plot(    x, 
         ...
         ylab ="Gene significance for Bc12", col = module)
...
# For dodgerblue1
#file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/B12", module, "GS_MM_genes.csv", sep = "_");
# For tomato2
file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/B12", module, "GS_MM_genes_low.csv", sep = "_");
