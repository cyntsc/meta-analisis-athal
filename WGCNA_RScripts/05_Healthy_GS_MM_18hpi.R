...
##                      ANALYSIS FOCUSED IN ARABIDOPSIS HEALTHY AT 18 HPI
##
###################################################################################################
...
# Define variable Healthy18 containing the Healthy18 column of datTrait2
Healthy18 = as.data.frame(datTraits2$healthy18);
names(Healthy18) = "Healthy18hpi"
...
geneTraitSignificance = as.data.frame(cor(athalDataHealthy, Healthy18, use = "p"));               # Gene Significance GS is the absolute value of the correlation between the gene and the trait.
GSPvalue = as.data.frame(corPvalueStudent(as.matrix(geneTraitSignificance), nSamples));
names(geneTraitSignificance) = paste("GS.", names(Healthy18), sep="");
names(GSPvalue) = paste("p.GS.", names(Healthy18), sep="");
...
plot(    x, 
         ...
         ylab ="Gene significance for healthy_18", col = module)
...
# For blue3:
#file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/Healthy_18", module, "GS_MM_genes.csv", sep = "_");
# For antiquewhite:
file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/Healthy_18", module, "GS_MM_genes_low.csv", sep = "_");
