...
##                      ANALYSIS FOCUSED IN ARABIDOPSIS WITH COLLETOTRICHUM At 40 HPI
##
###################################################################################################
...
# Define variable Ch_40 containing the Ch_40 column of datTrait2
Ch_40 = as.data.frame(datTraits2$Ch_40hpi);
names(Ch_40) = "Ch_40hpi"
...
geneTraitSignificance = as.data.frame(cor(athalData3, Ch_40, use = "p"));               # Gene Significance GS is the absolute value of the correlation between the gene and the trait.
GSPvalue = as.data.frame(corPvalueStudent(as.matrix(geneTraitSignificance), nSamples));
names(geneTraitSignificance) = paste("GS.", names(Ch_40), sep="");
names(GSPvalue) = paste("p.GS.", names(Ch_40), sep="");
...
# For green3: 
#file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/Ch40", module, "GS_MM_genes.csv", sep = "_");
# For palevioletred1:
file_name = paste("../results-data/All_Top15_GS_GO_TAIR_Annotations/Ch40", module, "GS_MM_genes_low.csv", sep = "_");
